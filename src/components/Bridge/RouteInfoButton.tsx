...
const RouteInfoButton: React.FC<Props> = ({ route }: Props) => {
  ...
  return (
    <button className="grid grid-cols-5 gap-4 px-3 py-3 rounded-lg hover:cursor-pointer w-full text-left text-sm text-fc font-normal border-2 border-bgLight">
      <img
